...
from models.SESNet import SESNet
...
def ValidateSegmentation(args):
    ...
    if args.file_root == 'LEVIR':
        # args.file_root = '/home/sdust307/ysq/CD/LEVIR-256'
        args.file_root = '/home/sdust307/ysq/CD/LEVIR-256'
        ...
        args.file_root = '/home/dell/exp/ysq/CDD'
    elif args.file_root == 'DSIFN':
        args.file_root = '/home/dell/exp/ysq/DSIFN-256'
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_root', default="CDD", help='Data directory | LEVIR | BCDD | SYSU ')
    ...
    parser.add_argument('--resume', default=None, help='Use this checkpoint to continue training | '
                                                       '/home/dml307/exp/ysq/SESNet1/SESNet9-main/results_DSIFN_iter_40000_lr_0.0005/checkpoint.pth.tar')
